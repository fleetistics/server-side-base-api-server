using fcm_notification_sender.core;
using Serilog;
...
builder.Services.AddSerilog((services, configuration) =>
{
	configuration
		...
		.Enrich.WithProperty("Application", "fcm-notification-sender");
});

// No-op unless actually launched under systemd (NotifyAccess=main): reports READY=1 once the
// host starts, and translates a systemd stop request into graceful shutdown.
